...
<head>
    ...
    <meta name="Description"
          content="[kt] 메인 - 사랑 받는 국민기업 kt의 기업홍보를 위한 사이트입니다. kt소개/사업소개/사회책임경영/투자정보/홍보채널/인재채용 등 kt의 다양한 사업과 서비스, 사회공헌활동 등에 대한 많은 정보를 확인할 수 있습니다.">
    <title>로그인 | 글로벌 No.1 KT</title>
    <script type="text/javascript" async
            src="https://remote.captcha.com/include.js?i=ATABMwExATQBMAJiMxNJAj8_CT9uPz8EP04_YA0_Pz8YATMBMAEwATMBMAEwATABMQprby1IYW5nLUtSAzIwMAIzOAExATABMw"></script>
    <script type="text/javascript" async
            src="https://remote.captcha.com/include.js?i=ATABMwExATQBMAJiMxNJAj8_CT9uPz8EP04_YA0_Pz8YATMBMAEwATMBMAEwATABMQprby1IYW5nLUtSAzIwMAIzOAExATABMw"></script>
    <script type="text/javascript" async
            src="https://remote.captcha.com/include.js?i=ATABMwExATQBMAJiMxNJAj8_CT9uPz8EP04_YA0_Pz8YATMBMAEwATMBMAEwATABMQprby1IYW5nLUtSAzIwMAIzOAExATABMw"></script>
    <script type="text/javascript" async
            src="https://remote.captcha.com/include.js?i=ATABMwExATQBMAJiMxNJAj8_CT9uPz8EP04_YA0_Pz8YATMBMAEwATMBMAEwATABMQprby1IYW5nLUtSAzIwMAIzOAExATABMw"></script>
    <script type="text/javascript" async
            src="https://www.google-analytics.com/gtm/js?id=GTM-KZPKL2N&amp;cid=960524965.1577545464"></script>
    ...
    <script type="text/javascript"
            src="https://login.kt.com/wamui/wamui/new_resources/p/cl/src/js/vendor/jquery-2.1.4.min.js"></script>
    <script>
...
<div class="security-code" id="normalPwdArea" style="">
    <div class="security-num" style="width:170px;height: 38px;">
        <img id="imagePlayer" alt="보안문자" style="width: 168px; height: 36px;"
             src="https://login.kt.com/wamui/botdetectcaptcha.do?get=image&amp;c=formCaptcha&amp;t=0a82ea2c2b4440e6bd9002477e95e486">
    </div>
    <ul>
        <li><a href="javascript:playSound();" onclick="trackClicks('로그인팝업', '^로그인 팝업^020_Captcha010_음성듣기');"
               class="voice"><i></i>음성듣기</a></li>
        <li><a href="javascript:playImage();" onclick="trackClicks('로그인팝업', '^로그인 팝업^030_Captcha020_새로고침');"
               class="refresh"><i></i>새로고침</a></li>
    </ul>
    <input type="text" id="captcha" name="captcha" maxlength="6" class="" autocomplete="off"
           placeholder="보안문자를 입력해 주세요." title="보안문자 입력" style="ime-mode:disabled;width:100%;"
           onfocus="showHideFocusBg(2);" onblur="showHideFocusBg(2);"
           onkeydown="if(event.keyCode==13){validate();}else if (event.keyCode== 32) {return false;}">
    <div id="botCaptchaDiv" style="display:none;">
        <div class="BDC_CaptchaDiv " id="formCaptcha_CaptchaDiv"
             style="width: 248px !important; height: 38px !important; ">
            <!--
            -->
            <div class="BDC_CaptchaImageDiv" id="formCaptcha_CaptchaImageDiv"
                 style="width: 200px !important; height: 38px !important;">
                <!--
                 -->
                <a href="//captcha.org/captcha.html?java" title="BotDetect Java CAPTCHA Library"
                   id="formCaptcha_HelpLink"><img class="BDC_CaptchaImage" id="formCaptcha_CaptchaImage"
                                                  src="https://login.kt.com/wamui/botdetectcaptcha.do?get=image&amp;c=formCaptcha&amp;t=0a82ea2c2b4440e6bd9002477e95e486"
                                                  alt=""></a>
                <!--
               -->
            ...
            <div class="BDC_CaptchaIconsDiv" id="formCaptcha_CaptchaIconsDiv" style="width: 42px !important;">
                <!--
                 -->
                <a class="BDC_ReloadLink" id="formCaptcha_ReloadLink" href="#" title="Change the CAPTCHA code"
                   style="display: inline-block !important;"><img class="BDC_ReloadIcon" id="formCaptcha_ReloadIcon"
                                                                  src="https://login.kt.com/wamui/botdetectcaptcha.do?get=reload-small-icon"
                                                                  alt=""></a>
                <!--
                 -->
                <a rel="nofollow" class="BDC_SoundLink" id="formCaptcha_SoundLink"
                   href="https://login.kt.com/wamui/botdetectcaptcha.do?get=sound&amp;c=formCaptcha&amp;t=0a82ea2c2b4440e6bd9002477e95e486"
                   title="Speak the CAPTCHA code"><img class="BDC_SoundIcon" id="formCaptcha_SoundIcon"
                                                       src="https://login.kt.com/wamui/botdetectcaptcha.do?get=sound-small-icon"
                                                       alt=""></a>
                <!--
                 -->
            ...
            <script src="https://login.kt.com/wamui/botdetectcaptcha.do?get=init-script-include&amp;c=formCaptcha&amp;t=0a82ea2c2b4440e6bd9002477e95e486"
                    type="text/javascript">
            </script>
        </div>
        <input type="hidden" id="BDC_VCID_formCaptcha" name="BDC_VCID_formCaptcha"
               value="0a82ea2c2b4440e6bd9002477e95e486">
